...
public interface IOsmGeoDataService
{
    ...
    Task<bool> IsInSettlementAreaAsync(double lat, double lng);    // 🏘️ Yerleşim kontrolü  
    Task<bool> IsInProtectedAreaAsync(double lat, double lng);     // 🛡️ Korunan alan kontrolü
